	...
	<tbody>
		...
		<tr>
			<td style="color:#666;font-size:12px;line-height:1.2em;padding:0 20px" colspan="2">
				<b>Welcome to TeachSpot.</b><br>
				When you enter the system for the first time, it is mandatory to change your password for security reasons.
				Press <a href="${passwordChangeUrl}">here</a> to enter. <br><br>
				Sincerely,<br>
                TeachSpot Team
			</td>
		</tr>
