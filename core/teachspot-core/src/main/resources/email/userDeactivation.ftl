	...
	<tbody>
		...
		<tr>
			<td colspan="2" style="margin:0 20px">
				<hr noshade="" color="#cccccc" style="margin:0 20px">
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td style="color:#666;font-size:12px;line-height:1.2em;padding:0 20px" colspan="2">
				<b>You are receiving this email because your email account (${email}) was deactivated from the Assortment Optimization Tool!</b>
				<br>For any further information please do not hesitate to contact us. <br><br>
				Sincerely,<br>
				Assortment Optimization Team
			</td>
		</tr>
		<tr>
			<td colspan="2" align="center" style="color:#666;font-size:10px;padding:0 20px"><br> <br>
