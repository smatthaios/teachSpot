...
<table width="600" align="center" cellpadding="0" cellspacing="0" style="border:1px solid #ccc;background:#fff;font-family: Verdana">
	<tbody>
		...
		<tr>
			<td colspan="2" style="font-size:14px;margin:0px;color:#666;padding:20px 20px 0px">Hello ${firstName},</td>
		</tr>
		<tr>
			<td style="color:#666;font-size:12px;line-height:1.2em;padding:0 20px" colspan="2">
				Το Μάτσου Πίτσου πλησιάζει! <3 ( <-- kardia) . <br><br>
				Φιλάκια,<br>
                Stelios Matthaios - TeachSpot Team
			</td>
		</tr>
		<tr>
