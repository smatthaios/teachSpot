...
<table width="600" align="center" cellpadding="0" cellspacing="0" style="border:1px solid #ccc;background:#fff;font-family: Verdana">
	<tbody>
		<tr>
			<td width="150" style="padding:10px 0px 5px 20px"><img height="80" src="http://www.iriworldwide.com/portals/0/skins/iri/images/logo.png" align="absmiddle" title="Iriworldwide.com" border="0"></td>
			<td width="350" style="padding:10px 5px; vertical-align: bottom"><span style="font-size: 25px; color: #38447D; font-family: Verdana"><b>Assortment Optimization</b></span></td>
		</tr>
		<tr>
		...
		<tr>
			<td style="color:#666;font-size:12px;line-height:1.2em;padding:0 20px" colspan="2">
				Simulation result for scenario <b>${scenarioName}</b> has finished. <br>
				Press <a href="${simulationResultUrl}">here</a> to enter the system and view the results.<br><br>
				Sincerely,<br>
