...
/** The {@link gr.teachspot.library.exception.UserNotFoundException} must be thrown when a {@link gr.teachspot.library.domain.User} is not found in the user repository. */
