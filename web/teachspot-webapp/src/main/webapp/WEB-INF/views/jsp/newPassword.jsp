...
<html>
	...
	<body ng-app="app" id="ng-app" ng-cloak class="login-body">
		...
		<div ng-controller="Login" class="overflow-hidden">
            <img src="<c:url value="/img/weather.png"/>" class="img-responsive cart" />
			...
			<form autocomplete="off" class="col-lg-offset-3 col-lg-6 col-md-offset-2 col-md-8 col-sm-offset-2 col-sm-10">
				...
				<div class="grid2">
                    <span>
                        ...
                        <%--<ul>
                            <li><fmt:message key="general.label.rightDisclaimer.li1" /></li>
                            <li><fmt:message key="general.label.rightDisclaimer.li2" /></li>
                            <li><fmt:message key="general.label.rightDisclaimer.li3" /></li>
                        </ul>--%>
                    </span>
				</div>
			</form>
